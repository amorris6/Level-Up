...
class ofApp : public ofBaseApp {
   private:
    ...
    const static float kItemTypeMsgXFactor;
    ...
    const static int kMaxPageNum = 5;
    const static int kWeaponPageNum = 1;
    const static int kArmorPageNum = 2;
    const static int kGemPageNum = 3;
    ...
    const static int kFastBattleGemPosIndex = 0;
    const static int kFastBattleGemPrice = 400;
    const static int kSlowBattleGemPosIndex = 1;
    const static int kSlowBattleGemPrice = 1200;
    const static int kMoreExpGemPosIndex = 2;
    const static int kMoreExpGemPrice = 2100;
    const static int kMoreGoldGemPosIndex = 3;
    const static int kMoreGoldGemPrice = 1700;
    const static int kMoreCritChanceGemPosIndex = 4;
    const static int kMoreCritChanceGemPrice = 4500;
    const static int kMoreCritDmgGemPosIndex = 5;
    const static int kMoreCritDmgGemPrice = 5000;
    ...
    const static string kWeaponsLabel;
    const static string kArmorLabel;
    const static string kGemsLabel;
    const static string kMiscLabel;
