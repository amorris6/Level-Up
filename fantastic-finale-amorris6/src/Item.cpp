...
Item::Item(string name, int price, int store_page, int inv_page,
    ...
    equip_button = new Button(store_pos_x + kEquipXAdj, store_pos_y + kHeight,
...
Item::Item(string name, int price, int store_page, int inv_page,
    ...
    : Item(name, price, store_page, inv_page, store_pos.x, store_pos.y,
           inv_pos.x, inv_pos.y, button_font) {}
